...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('resource_type', models.CharField(choices=[('Presentation', 'Presentation'), ('Worksheet', 'Worksheet'), ('Test', 'Test'), ('Mark Scheme', 'Mark Scheme'), ('Web Page', 'Web Page')], max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classgroups', models.ManyToManyField(blank=True, null=True, to='school.ClassGroup')),
            ],
        ),
        migrations.CreateModel(
