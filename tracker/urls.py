...
urlpatterns = [
    ...
    path('check/<classgroup_pk>', views.classgroup_all_syllabuses_completion, name='classgroup_all_syllabuses_completion'),
    path('check/syllabus/<int:syllabus_pk>/<classgroup_pk>', views.classgroup_syllabus_completion, name='classgroup_syllabus_completion'),
    path('check/topic/<int:topic_pk>/<classgroup_pk>', views.classgroup_topic_completion, name='classgroup_topic_completion'),
    path('sub-topic/<int:sub_topic_pk>/<classgroup_pk>', views.classgroup_sub_topic_completion, name='classgroup_sub_topic_completion'),
...
#   path('', views.tracker_overview, name='tracker_overview'), REDUNDANT?
    ...
    path('student_single_graph/<int:student_pk>/<int:sub_topic_pk>', views.single_sub_topic_graph_check, name='student_single_graph_check'),
